...
@pytest.mark.parametrize("command,allowed", [
    ...
    ("python3 child_wait.py 180", True),
    ("python3 child_wait.py 180.0", True),
    ("python3 child_wait.py 0.05", True),
    ("python3 child_wait.py 1e2", True),
    ("cd . && python3 child_wait.py", True),
    ("cd . && python3 child_wait.py 180", True),
    ("python3 child_wait.py 0", False),
    ("python3 child_wait.py -1", False),
    ("python3 child_wait.py 181", False),
    ("python3 child_wait.py NaN", False),
    ("python3 child_wait.py inf", False),
    ("python3 child_wait.py 1e999", False),
    ("python3 child_wait.py 180 extra", False),
    ("python3 child_wait.py 180; true", False),
    ("python3 child_wait.py 180 || true", False),
